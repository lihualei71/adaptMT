...
adapt <- function(x, pvals, models,
    ...
    for (i in 1:(nrow(stamps) - 1)){
        ...
        nreveals <- min(sum(mask), end - start) # number of hypotheses to be revealed
